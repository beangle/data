...
package org.beangle.data.hibernate.jdbc
...
object NullableIntJdbcType extends JdbcType {
  ...
  @nowarn
  override def getRecommendedJavaType(length: Integer, scale: Integer, typeConfiguration: TypeConfiguration): JavaType[_] = {
