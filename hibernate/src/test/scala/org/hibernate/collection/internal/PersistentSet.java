...
/**
 * A persistent wrapper for a <tt>java.util.Set</tt>. The underlying collection
 * is a <tt>HashSet</tt>.
 *
...
public class PersistentSet extends AbstractPersistentCollection implements java.util.Set {
  ...
  /**
   * Constructor matching super. Instantiates a lazy set (the underlying set is
   * un-initialized).
   *
   * @param session
  ...
  /**
   * Instantiates a non-lazy set (the underlying set is constructed from the
   * incoming set reference).
   *
   * @param session
   *            The session to which this set will belong.
   * @param set
